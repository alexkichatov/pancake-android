...
public class DashboardFragment extends Fragment {
    ...
    public void onViewCreated(View fragView, Bundle savedInstanceState) {
         ...
         * imgview.setImageResource(R.drawable.menu_settings); imgview.setOnClickListener(new
         * OnClickListener() {
         * 
         * @Override public void onClick(View v) { Intent myIntent = new
         * Intent(DashboardFragment.this.getActivity(), SugarCrmSettings.class);
        ...
        for (Iterator<String> iterator = mModuleNames.iterator(); iterator.hasNext();) {
            // View view =
            // LayoutInflater.from(getActivity().getBaseContext()).inflate(R.layout.dashboard_item,
            // null, false);
            Button view = (Button) LayoutInflater.from(getActivity().getBaseContext()).inflate(R.layout.dashboard_item, null, false);
            String moduleName = (String) iterator.next();
            view.setText(moduleName);
