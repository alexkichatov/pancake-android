...
public class CustomActionbar extends RelativeLayout implements OnClickListener {
    ...
    public void setHomeAction(Action action) {
        ...
        mHomeView.setImageResource(action.getDrawableId());
        mHomeView.setVisibility(View.VISIBLE);
        if (action.getDrawableId() == R.drawable.home)
    ...
    private View inflateAction(Action action) {
         ...
         * view.findViewById(R.id.actionbar_itemtext); tv.setText(action.getTitle()); }
         */
    ...
    private class PopupAction extends AbstractAction {
        ...
        public void performAction(View view) {
            if (!mPopupWindow.isShowing()) {
                ...
                mPopupWindow.setHeight((getResources().getInteger(R.integer.actionbar_popupheight))
                                                * mChildCount);
                mPopupWindow.update();
    ...
    private void inflatePopupMenu(Action itemAction, Action action) {
        this.addActionItem(new PopupAction(itemAction.getDrawableId()), 2);
        ...
        if (itemAction.getDrawableId() != R.drawable.relation)
