...
/**
 * Modified version of AsyncTask borrowed from Android open source which does
 * not post to UI but offers benefits in thread pooling etc, and additionaly
 * handles wake locks for subclasses, creates, aquires and releases the lock
 ...
 * <h2>Usage</h2>
 * <p>
 * AsyncServiceTask must be subclassed to be used. The subclass will override at
 * least one method ( {@link #doInBackground})
 * </p>
 * 
 * 
 * <p>
